L.Control.SlideMenuCredits = L.Control.extend({
    options: {
        position: 'topleft',
    ...
    onAdd: function(map){
        ...
        this._menu = L.DomUtil.create('div', 'leafletcredits-menu', map._container);
        ...
        var closeButton = L.DomUtil.create('button', 'leafletcredits-menu-close-button', this._menu);
        ...
        this._contents = L.DomUtil.create('div', 'leafletcredits-menu-contents', this._menu);
    ...
    _animate: function(menu, from, to, isOpen, ispx, unit){
        ...
        if(from != to){
            setTimeout(function(slideMenuCredits){
                var value = isOpen ? from + unit : from - unit;
                slideMenuCredits._animate(slideMenuCredits._menu, value, to, isOpen, ispx, unit);
...
L.control.slideMenuCredits = function(innerHTML, options) {
    return new L.Control.SlideMenuCredits(innerHTML, options);
};
